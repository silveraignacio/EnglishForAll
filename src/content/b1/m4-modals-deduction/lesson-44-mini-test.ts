...
Nunca: "must to be", "can't is", "must has", "must have went".`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m4-l4-ex12',
      type: 'listening',
      concept: 'modals of deduction review listening',
      difficulty: 4,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Un detective explica cómo deduce cosas del presente y pasado usando modales. Observa que alguien debe de estar ocupado, que podrían haber ido al cine, y que no pueden haber dormido porque hay evidencia de movimiento.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 3,
            prompt: 'What can the detective deduce when an office is locked at noon?',
            correctAnswer: 'The person must be in a meeting or may be somewhere else',
            options: ['The person must be in a meeting or may be somewhere else', 'The person must be at home', 'The office is broken'],
            explanation: '"I think: the person must be in a meeting or may be somewhere else."',
          },
          {
            id: 'b1-m4-l4-ex12-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'If there is dust on a desk, the owner must have been there yesterday.',
            correctAnswer: 'false',
            explanation: '"If I find dust on a desk, I know the owner can\'t have been there yesterday." - Es lo opuesto.',
          },
          {
            id: 'b1-m4-l4-ex12-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 4,
            prompt: 'What does the detective emphasize about making deductions?',
            correctAnswer: 'He must have strong evidence to make conclusions',
            options: ['He must have strong evidence to make conclusions', 'He should always believe what people say', 'Deductions are always 100% correct'],
            explanation: '"I must have strong evidence to make conclusions."',
          },
        ],
      },
    },
    {
      id: 'b1-m4-l4-ex13',
      type: 'writing',
      concept: 'modals of deduction review writing',
      difficulty: 4,
      prompt: 'Escribí una historia corta (mini-story) sobre un misterio, usando deducciones en presente y pasado con modales (must be, can\'t be, might be, must have, can\'t have, might have).',
      promptTranslation: 'Write a short story about a mystery using present and past deductions with modals.',
      correctAnswer: '',
      explanation: 'Un buen texto incluye: deducciones en presente (must be/can\'t be/might be) sobre la situación actual, deducciones en pasado (must have/can\'t have/might have) sobre lo que pasó, y una conclusión lógica.',
      taskType: 'story',
      targetReader: 'a reader',
      register: 'neutral',
      contentPoints: ['Una situación misteriosa o desconocida', 'Deducciones presentes y pasadas usando al menos 4 modales diferentes', 'Una conclusión basada en las deducciones'],
    ...
    },
    {
      id: 'b1-m4-l4-ex14',
      type: 'speaking',
      concept: 'modals of deduction review pronunciation',
      difficulty: 3,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'He must be rich because he can\'t have worked so hard without earning a lot of money.',
      explanation: 'Practicá la pronunciación de "must be" en presente y "can\'t have" en pasado, y la entonación de la frase compleja con dos deducciones.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
