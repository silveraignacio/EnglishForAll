...
- El modal no cambia con la persona: he must, she must (nunca "he musts").`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m4-l1-ex12',
      type: 'listening',
      concept: 'present deduction listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Sarah y James se encuentran después de mucho tiempo. Sarah deduce que James está cansado porque tiene mal aspecto, que debe de estar ocupado porque no ha llamado, y que probablemente está comiendo bien porque se ve bien.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: 'Why does Sarah think James is exhausted?',
            correctAnswer: 'Because he looks terrible',
            options: ['Because he looks terrible', 'Because he is working tomorrow', 'Because he just arrived'],
            explanation: '"You look terrible — you must be exhausted!"',
          },
          {
            id: 'b1-m4-l1-ex12-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'According to Sarah, James looks healthy.',
            correctAnswer: 'true',
            explanation: '"You look healthy, so you must be eating well."',
          },
          {
            id: 'b1-m4-l1-ex12-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'What does Sarah deduce about James\'s health?',
            correctAnswer: 'He must be eating well and not in perfect condition',
            options: ['He must be eating well and not in perfect condition', 'He must be sick', 'He looks tired but is fine'],
            explanation: '"You look healthy, so you must be eating well" but "You can\'t be fine if you look that tired."',
          },
        ],
      },
    },
    {
      id: 'b1-m4-l1-ex13',
      type: 'writing',
      concept: 'present deduction writing',
      difficulty: 3,
      prompt: 'Escribile un email informal a un amigo describiendo qué dedices sobre otra persona basándote en evidencias actuales (usá "must be" y "can\'t be").',
      promptTranslation: 'Write an informal email to a friend describing what you deduce about another person based on current evidence.',
      correctAnswer: '',
      explanation: 'Un buen texto usa varias frases con must be (deducciones positivas) y can\'t be (deducciones negativas) con evidencias claras.',
      taskType: 'email',
      targetReader: 'a friend',
      register: 'informal',
      contentPoints: ['Al menos 2 deducciones positivas (must be)', 'Al menos 1 deducción negativa (can\'t be)', 'Evidencias específicas que sustentan cada deducción'],
    ...
    },
    {
      id: 'b1-m4-l1-ex14',
      type: 'speaking',
      concept: 'present deduction pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'She can\'t be at home because her car isn\'t there.',
      explanation: 'Practicá la pronunciación de "can\'t" (/kɑːnt/) y la entonación de la deducción negativa.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
