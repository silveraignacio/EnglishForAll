...
- can: can't/can + sujeto.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m12-l3-ex11',
      type: 'listening',
      concept: 'tag questions listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Una conversación donde Emma y Tom usan tag questions para confirmar información sobre sus vidas, trabajos y planes.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: 'How long has Tom been working in finance?',
            correctAnswer: 'Five years',
            options: ['Three years', 'Five years', 'Ten years'],
            explanation: '"I\'ve been there for five years."',
          },
          {
            id: 'b1-m12-l3-ex11-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'Emma has already started working as a doctor.',
            correctAnswer: 'false',
            explanation: '"I haven\'t started working yet, have I?"',
          },
          {
            id: 'b1-m12-l3-ex11-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'What did Emma study at university?',
            correctAnswer: 'Medicine',
            options: ['Finance', 'Medicine', 'English'],
            explanation: '"You studied medicine, haven\'t you? Emma: Yes, I graduated last year."',
          },
        ],
      },
    },
    {
      id: 'b1-m12-l3-ex12',
      type: 'writing',
      concept: 'tag questions writing',
      difficulty: 3,
      prompt: 'Escribí un email a un colega o amigo usando tag questions para confirmar información sobre él/ella (su trabajo, su casa, sus planes, etc.).',
      promptTranslation: 'Write an email to a colleague or friend using tag questions to confirm information about them.',
      correctAnswer: '',
      explanation: 'Un buen texto usa varias tag questions con la regla de signos contrarios (afirmativa + tag negativa, negativa + tag afirmativa) de manera natural en la conversación.',
      taskType: 'email',
      targetReader: 'a colleague or friend',
      register: 'informal',
      contentPoints: ['Al menos tres tag questions diferentes', 'Mezcla de tag questions afirmativas y negativas'],
    ...
    },
    {
      id: 'b1-m12-l3-ex13',
      type: 'speaking',
      concept: 'tag questions pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'You play football, don\'t you?',
      explanation: 'Practicá la entonación de la tag question: la afirmación baja, la tag sube (como una pregunta).',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
