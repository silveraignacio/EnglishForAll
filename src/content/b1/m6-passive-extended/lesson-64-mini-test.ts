...
Nunca: "was not deliver", "will be open" (con agente), "must be finish", "got fire".`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m6-l4-ex14',
      type: 'listening',
      concept: 'passive extended review listening',
      difficulty: 4,
      prompt: 'Escuchá el audio sobre una conferencia internacional y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'La coordinadora de una conferencia informa sobre los preparativos: el lugar fue elegido hace seis meses, los pasajes deben reservarse en línea, se proporcionarán servicios de traducción simultánea, y se celebrará una cena formal.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 3,
            prompt: '¿Cuándo fue seleccionado el lugar?',
            correctAnswer: 'Hace seis meses',
            options: ['Hace seis meses', 'Hace un mes', 'La semana pasada'],
            explanation: '"The venue was selected six months ago after careful consideration."',
          },
          {
            id: 'b1-m6-l4-ex14-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'Los participantes deberán pagar por el hotel.',
            correctAnswer: 'false',
            explanation: '"the rooms won\'t be charged to the participants."',
          },
          {
            id: 'b1-m6-l4-ex14-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 4,
            prompt: 'What will be available between sessions?',
            correctAnswer: 'Coffee breaks and networking areas',
            options: ['Coffee breaks and networking areas', 'Movies and games', 'Sports activities'],
            explanation: '"Coffee breaks can be arranged between sessions, and networking areas will be set up."',
          },
        ],
      },
    },
    {
      id: 'b1-m6-l4-ex15',
      type: 'writing',
      concept: 'passive extended review writing',
      difficulty: 4,
      prompt: 'Describile a un colega los pasos de un proyecto que será completado pronto, usando diferentes formas de pasiva (negativa, futura, con modales, con get).',
      promptTranslation: 'Describe to a colleague the steps of a project that will be completed soon, using different passive forms.',
      correctAnswer: '',
      explanation: 'Un buen texto mezcla pasiva negativa, futura, con modales y con get, describiendo un plan de proyecto con claridad y estructura lógica.',
      taskType: 'email',
      targetReader: 'a colleague',
      register: 'formal',
      contentPoints: ['Al menos 3 pasos diferentes usando formas de pasiva variadas', 'Indicación clara de tiempos (qué no se hace, qué se hará, qué debe hacerse)'],
    ...
    },
    {
      id: 'b1-m6-l4-ex16',
      type: 'speaking',
      concept: 'passive extended review pronunciation',
      difficulty: 3,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'The new museum will be opened by the mayor next month.',
      explanation: 'Practicá la pronunciación clara de toda la pasiva futura con agente, manteniendo una entonación formal y declarativa.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
