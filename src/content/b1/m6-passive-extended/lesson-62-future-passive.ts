...
- The results won't be announced today.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m6-l2-ex13',
      type: 'listening',
      concept: 'future passive listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Un reportero habla sobre un nuevo estadio deportivo: se abrirá en primavera, los entradas se venderán en línea, el transporte público será mejorado, y se celebrará una ceremonia de apertura especial.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: '¿Cuándo se abrirá el nuevo estadio?',
            correctAnswer: 'La próxima primavera',
            options: ['La próxima primavera', 'El próximo invierno', 'Mañana'],
            explanation: '"The stadium will be opened next spring."',
          },
          {
            id: 'b1-m6-l2-ex13-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'Las entradas se venderán en la taquilla del estadio.',
            correctAnswer: 'false',
            explanation: '"Tickets will be sold online from next Monday."',
          },
          {
            id: 'b1-m6-l2-ex13-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'What will be provided on opening day?',
            correctAnswer: 'Free transport',
            options: ['Free transport', 'Free food', 'Free parking'],
            explanation: '"Free transport will be provided on opening day."',
          },
        ],
      },
    },
    {
      id: 'b1-m6-l2-ex14',
      type: 'writing',
      concept: 'future passive writing',
      difficulty: 3,
      prompt: 'Escribile a un amigo/a describiendo los planes futuros para tu ciudad, escuela o compañía (usá la pasiva futura con "will be + participio").',
      promptTranslation: 'Write to a friend describing future plans for your city, school or company using future passive.',
      correctAnswer: '',
      explanation: 'Un buen texto usa varias frases con will be + participio, describiendo acciones futuras que serán realizadas, con un registro neutral o informal.',
      taskType: 'email',
      targetReader: 'a friend',
      register: 'informal',
      contentPoints: ['Al menos 2-3 cosas que se harán/abrirán/construirán en el futuro', 'Cuándo aproximadamente sucederán'],
    ...
    },
    {
      id: 'b1-m6-l2-ex15',
      type: 'speaking',
      concept: 'future passive pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'The results will be announced soon.',
      explanation: 'Practicá la pronunciación clara de "will be" y el participio "announced", manteniendo una entonación natural.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
