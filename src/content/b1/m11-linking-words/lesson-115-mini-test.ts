...
- exceso: too + adj + to. Suficiencia: adj + enough + to.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m11-l5-ex11',
      type: 'listening',
      concept: 'linking words listening',
      difficulty: 4,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Laura habla de su nuevo trabajo, usando conectores de contraste y causa para explicar sus sentimientos encontrados.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 3,
            prompt: 'What does Laura say is a problem with her new job?',
            correctAnswer: 'The commute is long',
            options: ['The commute is long', 'The salary is low', 'The team is unfriendly'],
            explanation: '"My new job is great, although the commute is really long."',
          },
          {
            id: 'b1-m11-l5-ex11-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'Laura is thinking about moving closer to the city.',
            correctAnswer: 'true',
            explanation: '"Because of that, I\'m thinking about moving closer to the city."',
          },
          {
            id: 'b1-m11-l5-ex11-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'What does Laura miss about her old job?',
            correctAnswer: 'Her old team',
            options: ['Her old team', 'The short commute', 'The low salary'],
            explanation: '"However, I miss my old team a lot."',
          },
        ],
      },
    },
    {
      id: 'b1-m11-l5-ex12',
      type: 'writing',
      concept: 'linking words writing',
      difficulty: 4,
      prompt: 'Escribí un breve artículo (article) sobre las ventajas y desventajas de trabajar desde casa. Usá al menos dos conectores de contraste (although/however) y uno de causa (because/so).',
      promptTranslation: 'Write a short article about the advantages and disadvantages of working from home.',
      correctAnswer: '',
      explanation: 'Un buen artículo conecta las ideas con although/however para contrastar ventajas y desventajas, y usa because/so para explicar causas, en un registro neutro apropiado para una revista.',
      taskType: 'article',
      targetReader: 'magazine readers',
      register: 'neutral',
      contentPoints: ['Al menos una ventaja y una desventaja', 'Usar although/however y because/so'],
    ...
    },
    {
      id: 'b1-m11-l5-ex13',
      type: 'speaking',
      concept: 'linking words pronunciation',
      difficulty: 3,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'It\'s a nice car. However, it\'s very expensive.',
      explanation: 'Practicá la pausa breve después de "However," (con coma) y la entonación descendente al final de cada frase.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
