...
- After we had eaten, we went for a walk.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m2-l3-ex10',
      type: 'listening',
      concept: 'narrative tenses listening',
      difficulty: 4,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Tom cuenta una historia que combina los tres tiempos: estaba caminando cuando algo sucedió, pero resulta que ya había pasado algo anteriormente que explicaba la situación.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 3,
            prompt: 'Where was Tom when the speaker found him?',
            correctAnswer: 'Sitting on a bench in the park',
            options: ['Sitting on a bench in the park', 'Walking through the park', 'At home with his girlfriend'],
            explanation: '"I was walking through the park when I saw Tom sitting on a bench."',
          },
          {
            id: 'b1-m2-l3-ex10-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'Tom had argued with his girlfriend that morning.',
            correctAnswer: 'true',
            explanation: '"He had argued with his girlfriend that morning before she left for work."',
          },
          {
            id: 'b1-m2-l3-ex10-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 4,
            prompt: 'Why hadn\'t Tom called his girlfriend yet?',
            correctAnswer: 'He was too nervous',
            options: ['He was too nervous', 'He didn\'t have her phone number', 'She had blocked his number'],
            explanation: '"He hadn\'t called her yet because he was too nervous."',
          },
        ],
      },
    },
    {
      id: 'b1-m2-l3-ex11',
      type: 'writing',
      concept: 'narrative tenses writing',
      difficulty: 4,
      prompt: 'Escribí una historia corta (80-100 palabras) sobre algo que pasó mientras estabas haciendo otra cosa. Usá: past continuous (lo que estabas haciendo), past simple (lo que interrumpió), y past perfect (qué había pasado antes).',
      promptTranslation: 'Write a short story about something that happened while you were doing something else using narrative tenses.',
      correctAnswer: '',
      explanation: 'Una buena narración combina los tres tiempos: estabas haciendo algo (past continuous), algo pasó (past simple) e interrumpió tu actividad, y había algo que había sucedido antes que explica la situación (past perfect).',
      taskType: 'story',
      targetReader: 'your teacher',
      register: 'neutral',
      contentPoints: ['Una situación de fondo (past continuous)', 'Un evento que interrumpe (past simple)', 'Una acción anterior que explica (past perfect)'],
    ...
    },
    {
      id: 'b1-m2-l3-ex12',
      type: 'speaking',
      concept: 'narrative tenses pronunciation',
      difficulty: 3,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'I was reading when I remembered that I had forgotten to pay the electricity bill.',
      explanation: 'Practicá los tres tiempos: "was reading" (continuidad, voz lenta), "remembered" (interrupción, voz más rápida), y "had forgotten" (retrospectiva, voz clara en "had").',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
