...
- En el negativo, el "don't" del estilo directo se convierte en "not to".`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m7-l3-ex11',
      type: 'listening',
      concept: 'reported commands listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Un padre da instrucciones a su hijo antes de ir al colegio. Debes responder qué órdenes y peticiones hizo.',
      listening: {
        audioText:
        ...
        questions: [
          {
            id: 'b1-m7-l3-ex11-q1',
            type: 'multiple_choice',
            concept: 'listening comprehension reported commands',
            difficulty: 2,
            prompt: 'What did the father ask the child to do first?',
            correctAnswer: 'Eat breakfast before leaving',
            options: ['Eat breakfast before leaving', 'Put on shoes', 'Call him at school'],
            explanation: '"I want you to eat your breakfast before you leave."',
          },
          {
            id: 'b1-m7-l3-ex11-q2',
            type: 'true_false',
            concept: 'listening comprehension reported commands',
            difficulty: 2,
            prompt: 'The father told the child not to run in the hallway at school.',
            correctAnswer: 'true',
            explanation: '"Don\'t run in the hallway at school."',
          },
          {
            id: 'b1-m7-l3-ex11-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension reported commands',
            difficulty: 3,
            prompt: 'What was the most important instruction?',
            correctAnswer: 'Not to talk to strangers',
            options: ['To listen to the teacher', 'Not to talk to strangers', 'To call when arriving'],
            explanation: '"Most importantly, don\'t talk to strangers."',
          },
        ],
      },
    },
    {
      id: 'b1-m7-l3-ex12',
      type: 'writing',
      concept: 'reported commands writing',
      difficulty: 3,
      prompt: 'Escribile un email a un colega resumiendo las instrucciones que te dio tu jefe en una reunión (usá tell/ask + to y tell + not to).',
      promptTranslation: 'Write an email to a colleague summarizing the instructions your boss gave in a meeting.',
      correctAnswer: '',
      explanation: 'Un buen email reporta órdenes y peticiones usando "told me to", "asked me to", "told me not to", etc.',
      taskType: 'email',
      targetReader: 'a colleague',
      register: 'formal',
      contentPoints: [
        'Al menos 2 órdenes o peticiones afirmativas (tell/ask + to)',
        'Al menos 1 orden o petición negativa (tell/ask + not to)',
      ],
    ...
    },
    {
      id: 'b1-m7-l3-ex13',
      type: 'speaking',
      concept: 'reported commands pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'The coach told us to warm up before the match and not to forget our water bottles.',
      explanation: 'Practicá la pronunciación de órdenes reportadas con "told us to" y negativas con "not to".',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
