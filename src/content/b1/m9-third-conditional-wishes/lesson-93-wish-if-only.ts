...
¡El verbo nunca va en presente después de "wish" para deseos irreales!`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m9-l3-ex11',
      type: 'listening',
      concept: 'wish and if only listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Dos personas expresan deseos y arrepentimientos sobre su vida actual y pasada: uno desea hablar idiomas, otro se arrepiente de no haber viajado más.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: 'What does Person A wish they could do?',
            correctAnswer: 'Speak more languages',
            options: ['Speak more languages', 'Travel more', 'Save more money'],
            explanation: '"I wish I could speak more languages."',
          },
          {
            id: 'b1-m9-l3-ex11-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'Person A wishes they had studied French when they were young.',
            correctAnswer: 'true',
            explanation: '"If only I had studied French when I was young."',
          },
          {
            id: 'b1-m9-l3-ex11-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'Why did Person B not travel more when younger?',
            correctAnswer: 'They didn\'t have the budget, although they had time',
            options: ['They didn\'t have the budget, although they had time', 'They were busy with work', 'They didn\'t know where to go'],
            explanation: '"I had the time, but I didn\'t have the budget."',
          },
        ],
      },
    },
    {
      id: 'b1-m9-l3-ex12',
      type: 'writing',
      concept: 'wish and if only writing',
      difficulty: 3,
      prompt: 'Escribile un email informal a un amigo/a expresando deseos y arrepentimientos personales (usá wish + pasado simple, wish + past perfect, e if only).',
      promptTranslation: 'Write an informal email to a friend expressing personal wishes and regrets.',
      correctAnswer: '',
      explanation: 'Un buen texto incluye al menos dos deseos/arrepentimientos con wish o if only, mantiene un registro informal y explica brevemente por qué.',
      taskType: 'email',
      targetReader: 'a friend',
      register: 'informal',
      contentPoints: ['Al menos dos deseos o arrepentimientos personales', 'Breve razón de por qué deseas o te arrepientes'],
    ...
    },
    {
      id: 'b1-m9-l3-ex13',
      type: 'speaking',
      concept: 'wish pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'If only I had spent more time with my family before they moved away.',
      explanation: 'Practicá la pronunciación de "if only" (énfasis leve en ambas palabras) y la entonación melancólica de un arrepentimiento personal.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
