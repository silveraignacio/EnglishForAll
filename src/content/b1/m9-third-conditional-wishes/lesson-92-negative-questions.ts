...
Recuerda: en la parte de "if" usamos past perfect (had/hadn't + participio), nunca "would".`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m9-l2-ex11',
      type: 'listening',
      concept: 'third conditional questions listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Tom entrevista a tres personas sobre decisiones pasadas usando preguntas en tercer condicional y ellos responden con respuestas cortas.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: 'Person A would have gone to university if the parents hadn\'t insisted.',
            correctAnswer: 'false',
            explanation: 'Person A says "No, I wouldn\'t have." — meaning they would not have gone.',
          },
          {
            id: 'b1-m9-l2-ex11-q2',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'What would Person B have done if the price had been lower?',
            correctAnswer: 'Bought the car',
            options: ['Bought the car', 'Sold the car', 'Rented the car'],
            explanation: 'Person B says "Yes, I would have." — responding to the question about buying the car.',
          },
          {
            id: 'b1-m9-l2-ex11-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'In the third question, Person C says they would have arrived on time. What was the condition?',
            correctAnswer: 'If they hadn\'t missed the train',
            options: ['If they hadn\'t missed the train', 'If they had taken a taxi', 'If they had left earlier'],
            explanation: 'Tom asks: "Would they have arrived on time if they hadn\'t missed the train?" Person C answers "Yes, they would have."',
          },
        ],
      },
    },
    {
      id: 'b1-m9-l2-ex12',
      type: 'writing',
      concept: 'third conditional negative writing',
      difficulty: 3,
      prompt: 'Escribile un email informal a un amigo/a sobre algo que no pudiste hacer en el pasado y explicá por qué (usá negativos y preguntas en tercer condicional).',
      promptTranslation: 'Write an informal email to a friend about something you couldn\'t do in the past and explain why.',
      correctAnswer: '',
      explanation: 'Un buen texto incluye negativos (if + hadn\'t, wouldn\'t have) y posiblemente preguntas (Would you have...?), con un registro informal adecuado.',
      taskType: 'email',
      targetReader: 'a friend',
      register: 'informal',
      contentPoints: ['Una situación que no sucedió en el pasado', 'La razón por la que no pasó'],
    ...
    },
    {
      id: 'b1-m9-l2-ex13',
      type: 'speaking',
      concept: 'third conditional question pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'Would you have come to the party if I had invited you earlier?',
      explanation: 'Practicá la pronunciación de la pregunta en tercer condicional: "Would have" + entonación de pregunta que sube al final.',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
