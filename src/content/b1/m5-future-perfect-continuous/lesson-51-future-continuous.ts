...
- Negativo: will not (won't) be + -ing: I won't be working.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m5-l1-ex12',
      type: 'listening',
      concept: 'future continuous listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'Sarah habla sobre su día mañana: volará a París por la mañana, asistirá a reuniones por la tarde, y cenará con amigos por la noche.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: 'What will Sarah be doing in the morning?',
            correctAnswer: 'Flying to Paris',
            options: ['Flying to Paris', 'Attending meetings', 'Having dinner'],
            explanation: '"I\'ll be flying to Paris in the morning — the flight leaves at 8 a.m."',
          },
          {
            id: 'b1-m5-l1-ex12-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'Sarah will be working at 2 o\'clock.',
            correctAnswer: 'true',
            explanation: '"At 2 o\'clock in the afternoon, I\'ll be attending important meetings."',
          },
          {
            id: 'b1-m5-l1-ex12-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: 'Who will she be having dinner with around 7 p.m.?',
            correctAnswer: 'Some friends',
            options: ['Some friends', 'Her clients', 'Her family'],
            explanation: '"Around 7 p.m., I\'ll be having dinner with some friends at a French restaurant."',
          },
        ],
      },
    },
    {
      id: 'b1-m5-l1-ex13',
      type: 'writing',
      concept: 'future continuous writing',
      difficulty: 3,
      prompt: 'Escribile un email informal a un amigo/a contándole qué estarás haciendo a esta hora la próxima semana (usá el future continuous).',
      promptTranslation: 'Write an informal email to a friend about what you will be doing at this time next week.',
      correctAnswer: '',
      explanation: 'Un buen texto usa varias frases con "will be + -ing" para describir acciones en progreso en momentos futuros específicos, manteniendo un registro informal.',
      taskType: 'email',
      targetReader: 'a friend',
      register: 'informal',
      contentPoints: ['Qué estarás haciendo a esta hora la próxima semana', 'Dónde estarás o quién estará contigo'],
    ...
    },
    {
      id: 'b1-m5-l1-ex14',
      type: 'speaking',
      concept: 'future continuous pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'At this time tomorrow, I will be relaxing on the beach.',
      explanation: 'Practicá la pronunciación de "will be relaxing" (enfatiza el acento en "RE-lax-ing") y la pausa antes de "on the beach".',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
