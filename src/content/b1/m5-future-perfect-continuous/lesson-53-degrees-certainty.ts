...
- "may" y "might" van seguidos del verbo en infinitivo.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-m5-l3-ex13',
      type: 'listening',
      concept: 'degrees of certainty listening',
      difficulty: 3,
      prompt: 'Escuchá el audio y respondé las preguntas (en inglés, sobre lo que dice).',
      correctAnswer: '',
      explanation: 'David hace predicciones sobre su futuro con diferentes niveles de certeza: seguramente irá a la universidad, probablemente viajará al extranjero, puede que trabaje en una gran empresa, y quizá se case pronto.',
      listening: {
        audioText:
        ...
        questions: [
          {
            ...
            difficulty: 2,
            prompt: 'What will David definitely do?',
            correctAnswer: 'Go to university',
            options: ['Go to university', 'Work for a large company', 'Get married soon'],
            explanation: '"I will definitely go to university — my family expects it and it\'s my dream."',
          },
          {
            id: 'b1-m5-l3-ex13-q2',
            type: 'true_false',
            concept: 'listening comprehension',
            difficulty: 2,
            prompt: 'David will probably stay in his hometown after graduation.',
            correctAnswer: 'false',
            explanation: '"I will probably travel abroad after graduation, maybe to Asia or Europe."',
          },
          {
            id: 'b1-m5-l3-ex13-q3',
            type: 'multiple_choice',
            concept: 'listening comprehension',
            difficulty: 3,
            prompt: '¿Cuán probable es que David se case pronto?',
            correctAnswer: 'Poco probable (might)',
            options: ['Casi seguro (definitely)', 'Probable (probably)', 'Poco probable (might)'],
            explanation: '"But I might get married soon too" expresa baja probabilidad.',
          },
        ],
      },
    },
    {
      id: 'b1-m5-l3-ex14',
      type: 'writing',
      concept: 'degrees of certainty writing',
      difficulty: 3,
      prompt: 'Escribe un artículo neutral sobre predicciones para la próxima década, usando diferentes grados de certeza (definitely, probably, likely, may, might).',
      promptTranslation: 'Write a neutral article about predictions for the next decade, using different degrees of certainty.',
      correctAnswer: '',
      explanation: 'Un buen texto usa una variedad de estructuras de certeza (will definitely, will probably, be likely to, may, might) para expresar predicciones sobre tecnología, medio ambiente o sociedad, con un tono neutro y educativo.',
      taskType: 'article',
      targetReader: 'general readers',
      register: 'neutral',
      contentPoints: ['Predicciones sobre qué sucederá en la próxima década', 'Uso de diferentes grados de certeza (definitely, probably, may, might)'],
    ...
    },
    {
      id: 'b1-m5-l3-ex15',
      type: 'speaking',
      concept: 'degrees of certainty pronunciation',
      difficulty: 2,
      prompt: 'Escuchá la frase modelo y repetila en voz alta.',
      correctAnswer: 'Climate change will definitely affect the world in the next decade.',
      explanation: 'Practicá enfatizando "definitely" con entonación fuerte (expresando seguridad) y la pronunciación fluida de "will affect".',
      speakingMode: 'repeat',
    },
  ],
  miniTest: [
