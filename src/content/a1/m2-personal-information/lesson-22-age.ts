...
5. **Sin "years old"**: también es válido decir solo "I am 30" (se sobreentiende "años").`,
  ...
  miniTest: [
    ...
    },
    {
      ...
      difficulty: 2,
      prompt: 'Completa: "I\'m 30 ___." (forma completa)',
      promptTranslation: 'Fill in: full form.',
      correctAnswer: 'years old',
      explanation: 'Forma corta: "I\'m 30." (sin nada). Forma completa: "I\'m 30 years old." Ambas son correctas, pero aquí te pedimos la forma completa.',
    },
    {
      id: 'a1-m2-l2-mt4',
      type: 'translate',
